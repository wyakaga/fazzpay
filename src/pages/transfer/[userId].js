...
function TransferDetail() {
  ...
  const clickHandler = (e) => {
    ...
    if (parsedAmount <= 1000) {
      return toast.error("Minimal amount is should be more than 1000");
    }

    if (parsedAmount > balance) {
      return toast.error("Balance is less than transaction amount");
    }
    ...
    toast.promise(checkPin(intPin, token, controller), {
      ...
      success: {
        render() {
          ...
          transfer(userId, persistedAmount, persistedNotes, token, controller)
            .then(() => {
        ...
        <PhoneCheck>
          ...
          >
            ...
            <div className="container">
                  ...
                  <section className="top flex flex-col gap-y-5">
                    <div>
                      <p className="font-bold text-lg text-fazzpay-dark">
                        {isConfirmed ? "Transfer to" : "Transfer Money"}
                      </p>
                    </div>
                            ...
                            >
                              ...
                              <div>
                                <p className="font-bold text-[#514F5B] text-2xl">
                                  {detail.title === "Balance Left" ||
                                  detail.title === "Amount"
                                    ? `Rp${detail.content.toLocaleString(
                                        "id-ID"
                                      )}`
                                    : detail.content}
                                </p>
              ...
              <Transition appear show={isModalPin} as={Fragment}>
                <Dialog
                  as="div"
                ...
                >
                  ...
                  <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen">
                      ...
                      >
                        <Dialog.Panel className="bg-fazzpay-secondary w-full md:w-1/2 lg:w-1/3 p-5 rounded-lg shadow-lg z-20">
...
export default TokenHandler(TransferDetail);
